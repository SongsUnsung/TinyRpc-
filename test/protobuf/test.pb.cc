...
const char descriptor_table_protodef_test_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "onse\022O\n\016GetFriednLists\022\035.fixbug.GetFrien"
...
GetFriendListsResponse::_table_ = {
  {
    ...
    // .fixbug.ResultCode result = 1;
    {PROTOBUF_FIELD_OFFSET(GetFriendListsResponse, _impl_.result_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    // repeated .fixbug.User friend_list = 2;
    {PROTOBUF_FIELD_OFFSET(GetFriendListsResponse, _impl_.friend_list_), -1, 1, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
      {::_pbi::TcParser::GetTable<::fixbug::ResultCode>()},
...
void UserServiceRpc::GetFriednLists(::google::protobuf::RpcController* PROTOBUF_NULLABLE controller,
                         const ::fixbug::GetFriendListsRequest* PROTOBUF_NONNULL,
                         ::fixbug::GetFriendListsResponse* PROTOBUF_NONNULL,
                         ::google::protobuf::Closure* PROTOBUF_NULLABLE done) {
  controller->SetFailed("Method GetFriednLists() not implemented.");
  done->Run();
}
...
void UserServiceRpc::CallMethod(
  ...
  switch (method->index()) {
    case 0:
      ...
      break;
    case 1:
      this->GetFriednLists(controller, ::google::protobuf::DownCastMessage<::fixbug::GetFriendListsRequest>(request),
...
void UserServiceRpc_Stub::GetFriednLists(
    ::google::protobuf::RpcController* PROTOBUF_NULLABLE controller,
